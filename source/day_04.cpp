...
ints_t_3d parse(strings_t input)
{
    ...
    for (auto line : input)
    {
        strings_t range_strings = substrings_to_strings(line, ",");
        ints_t range1 = substrings_to_ints(range_strings.at(0), "-");
        ints_t range2 = substrings_to_ints(range_strings.at(1), "-");
        ints_t_2d range_pair;
        range_pair.push_back(matlab_colon(range1.at(0), range1.at(1)));
        range_pair.push_back(matlab_colon(range2.at(0), range2.at(1)));
